...
```{r}
age_mean <- function(mean) {
data <- as.tibble(train) # convert input data set to a tibble
mean_age <- mean(train$Age, na.rm = TRUE) # take the mean of Age, remove NAs
...
<p> We see a similar mean across our bootstrapped samples, which shows the CLM is holding.
...
<insert see notes from class 9.1>
